...
"""
swinunet_main_v6_config.py

目的:
- src/CompresionRain/swinunet_main_v6.py 内の「ハイパーパラメータ/設定値」を一元管理し、ここだけを編集すれば調整できるようにする
...
CFG = {
    ...
    "PATHS": {
        ...
        "result_dir": "swin-unet_main_result_v6",

        # 生成ファイル（result_dir配下）
        "model_save_name": "best_swin_unet_model_ddp_monthly_v6.pth",
        "plot_save_name": "loss_curve_monthly_v6.png",
        "result_img_dir_name": "result_images_monthly_v6",
        "result_img_dir_name_rn": "result_images_monthly_RN_v6",
        "main_log_name": "main_v6.log",
        "exec_log_name": "execution_v6.log",
        "evaluation_log_name": "evaluation_v6.log",
        "epoch_metric_plot_dir_name": "epoch_metrics_plots_v6",
        "video_name": "validation_results_v6.mp4",
    },
...
ALLOCATION_TAU = float(CFG["MODEL"].get("allocation_softmax_tau", 1.0))
...
def print_cfg_summary():
    ...
    """
    print("=== SwinUNet v6 Config Summary ===")
    print(f"SEED: {SEED}")
